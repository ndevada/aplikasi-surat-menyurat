...
$sql = "SELECT no_urut, nmr_surat, almt_instansi ";
$sql.=" FROM minstansi";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $nestedData[] = '<td><center>
                     <a href="edit-instansi?id='.$row['kd_instansi'].'"  data-toggle="tooltip" title="Edit" class="btn btn-sm btn-primary"> <i class="glyphicon glyphicon-edit"></i> </a>
