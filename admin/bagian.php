...
<div class="panel-body">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Daftar Bagian</li>
          </ol>
        </section>
                ...
                <div class="box-body">
                  ...
                  <?php
                     if(isset($_GET['aksi']) == 'delete'){
        				        $id = $_GET['id'];
                        $data = "SELECT kd_bagian FROM m_bagian WHERE kd_bagian=?";
                        ...
                        $check  = mysqli_num_rows($result);
                             ...
                             $pro = "DELETE FROM m_bagian WHERE kd_bagian=?";
          			   ...
          			   ?>
                   <a href="input-bagian.php" class="btn btn-sm btn-default"><i class="fa fa-plus"></i> Tambah Data</a>
                   <a href="laporan/laporan_bagian.php" target="_blank" class="btn btn-sm btn-success pull-right"><i class="fa fa-file"></i> Cetak Laporan</a>
                   <br />
                   <br />
                     <table id="tbagian" class="table table-bordered table-hover">  
...
<script>
          $(document).ready(function() {
  				var dataTable = $('#tbagian').DataTable( {
            "responsive": true,
            "processing": true,
  					"serverSide": true, 
  					"ajax":{
  						url :"ajax-bagian.php", // json datasource
