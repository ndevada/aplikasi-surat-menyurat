...
<div class="panel-body">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Daftar Jenis Surat</li>
          </ol>
        </section>
                ...
                <div class="box-body">
                  ...
                  <?php
                     if(isset($_GET['aksi']) == 'delete'){
        				        $id   = $_GET['id'];
                        $data = "SELECT kd_jenis FROM mjenis WHERE kd_jenis=?";
                      ...
                      if($hitung == 0){
                        ...
                        $pro = "DELETE FROM mjenis WHERE kd_jenis=?";
                        $del = mysqli_prepare($koneksi, $pro);
          			   ...
          			   ?>
                   <a href="input-jenis.php" class="btn btn-sm btn-default"><i class="fa fa-plus"></i> Tambah Data</a>
                   <a href="laporan/laporan_jenis.php" target="_blank" class="btn btn-sm btn-success pull-right"><i class="fa fa-file"></i> Cetak Laporan</a>
                   <br />
                   <br />
...
<script>
          $(document).ready(function() {
            ...
            "processing": true,
  					"serverSide": true, 
  					"ajax":{
  						url :"ajax-jenis.php", // json datasource
