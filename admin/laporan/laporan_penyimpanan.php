    ...
    if (empty($_SESSION['username'])){
        ...
        <div class="container">
            <div id="colres">
                ...
                <div class="tgh" id="lbr">LAPORAN DATA TEMPAT PENYIMPANAN SURAT</div>
                </br>
                </br>
                <div class="separator"></div>';
                ...
                <tr>
                <th>No.</th>
                <th>Nama Tempat Penyimpanan Surat</th>          
                </tr>
                </thead>';


                $query = mysqli_query($koneksi, "SELECT * FROM mpnympn ORDER BY kd_simpan ASC");
