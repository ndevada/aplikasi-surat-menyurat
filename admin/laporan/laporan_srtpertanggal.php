    ...
    if (empty($_SESSION['username'])){
        ...
        <div class="container">
            <div id="colres">
                ...
                $query = mysqli_query($koneksi, "SELECT * FROM tsuratmasuk T INNER JOIN minstansi I ON T.kd_instansi = I.kd_instansi INNER JOIN mpnympn P ON T.kd_simpan = P.kd_simpan WHERE (tgl_diterima BETWEEN '$dari' AND '$sampai') ORDER BY tgl_diterima ASC");
