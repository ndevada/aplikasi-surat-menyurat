    ...
    if (empty($_SESSION['username'])){
        ...
        <div class="container">
            <div id="colres">
                ...
                <div class="tgh" id="lbr">LAPORAN SURAT DISPOSISI TANGGAL '.$d2." ".strtoupper($nm2)." ".$y2.' - '.$d3." ".strtoupper($nm3)." ".$y3.'</div>
                </br>
                </br>
                <div class="separator"></div>';
                ...
                $query = mysqli_query($koneksi, "SELECT * FROM disposisi D INNER JOIN tsuratmasuk T ON D.urut = T.no_urut INNER JOIN m_bagian B on D.kd_bagian = B.kd_bagian INNER JOIN minstansi I on T.kd_instansi=I.kd_instansi WHERE (tgl_disposisi BETWEEN '$dari' AND '$sampai') ORDER BY tgl_disposisi ASC");
...
*/
                    $y1 = substr($row['tgl_disposisi'],0,4);
                    $m1 = substr($row['tgl_disposisi'],5,2);
                    $d1 = substr($row['tgl_disposisi'],8,2);
