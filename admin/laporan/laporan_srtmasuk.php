    ...
    if (empty($_SESSION['username'])){
        ...
        <div class="container">
            <div id="colres">
                ...
                <div class="tgh" id="lbr">LAPORAN SURAT MASUK</div>
                </br>
                </br>
                <div class="separator"></div>';
                ...
                $query = mysqli_query($koneksi, "SELECT * FROM tsuratmasuk T INNER JOIN minstansi I ON T.kd_instansi = I.kd_instansi INNER JOIN mpnympn P ON T.kd_simpan = P.kd_simpan ORDER BY no_urut ASC");
