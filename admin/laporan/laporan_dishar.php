    ...
    if (empty($_SESSION['username'])){
        ...
        <div class="container">
            <div id="colres">
                ...
                <div class="tgh" id="lbr">LAPORAN DISPOSISI SURAT</div>
                </br>
                </br>
                <div class="separator"></div>';
                ...
                $query = mysqli_query($koneksi, "SELECT * FROM disposisi D INNER JOIN tsuratmasuk T ON D.urut = T.no_urut INNER JOIN m_bagian B on D.kd_bagian = B.kd_bagian INNER JOIN minstansi I on T.kd_instansi=I.kd_instansi WHERE tgl_disposisi = '$now' ORDER BY  id_disposisi ASC");
