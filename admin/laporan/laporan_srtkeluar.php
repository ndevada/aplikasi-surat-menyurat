    ...
    if (empty($_SESSION['username'])){
        ...
        <div class="container">
            <div id="colres">
                ...
                $query = mysqli_query($koneksi, "SELECT *, CONCAT(no_urutkl,'/',kd_klasifikasi,'/',ket_nmr) AS asasa from tsuratkeluar T INNER JOIN mjenis I ON T.kd_jenis = I.kd_jenis INNER JOIN minstansi B ON T.kd_instansi = B.kd_instansi ORDER BY  kode_srtkeluar ASC");
