    ...
    if (empty($_SESSION['username'])){
        ...
        <div class="container">
            <div id="colres">
                ...
                <div class="tgh" id="lbr">LAPORAN SURAT MASUK TANGGAL '.$d3." ".strtoupper($nm3)." ".$y3.'</div>
                </br>
                </br>
                <div class="separator"></div>';
                ...
                $query = mysqli_query($koneksi, "SELECT * FROM tsuratmasuk T INNER JOIN minstansi I ON T.kd_instansi = I.kd_instansi INNER JOIN mpnympn P ON T.kd_simpan = P.kd_simpan WHERE tgl_diterima = '$hari' ORDER BY tgl_diterima ASC");
